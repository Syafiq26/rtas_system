    ...
    <div class="row">
        ...
        <main role="main" class="col-md-9 ml-sm-auto col-lg-10 px-4">
            <div class="main-content mt-4">
                <div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center pb-2 mb-3 border-bottom">
                    ...
                    <div class="btn-toolbar mb-2 mb-md-0">
                        <div class="btn-group mr-2">
                            <a href="<?php echo e(url()->previous()); ?>" class="btn btn-secondary">Back to List</a>
                        </div>
                    </div>
                </div>
                ...
                <?php if($candidate->remark): ?>
                <div class="section">
                    <h3 class="section-title">Remark</h3>
                    <div class="p-3">
                        <?php echo e($candidate->remark); ?>
...
<?php /**PATH C:\xampp\htdocs\rtas_system\resources\views/admin/viewCandidate.blade.php ENDPATH**/ ?>