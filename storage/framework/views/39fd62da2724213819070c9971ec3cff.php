      ...
      <form method="post" action=" ">
        <div class="table-responsive">
          ...
          <table class="table table-striped">
            ...
            <tbody>
              <?php $__currentLoopData = $kivCandidates; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $candidate): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
              <tr>
                ...
                <td>
                    <a href="<?php echo e(route('kiv.viewCandidate', $candidate->id)); ?>" class="btn btn-secondary btn-sm">View</a>
                    <a href="<?php echo e(route('kiv.edit', $candidate->id)); ?>" class="btn btn-info btn-sm">Edit</a>
                </td>
              </tr>
...
</html><?php /**PATH C:\xampp\htdocs\rtas_system\resources\views/admin/kiv.blade.php ENDPATH**/ ?>