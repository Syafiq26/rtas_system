      ...
      <div class="main-content mt-4">
        ...
        <form method="post" action="<?php echo e(route('staff.update', $staff->id)); ?>">
          ...
          <div class="form-group row">
            ...
            <div class="col-sm-10">
              <input type="text" name="name" class="form-control" value="<?php echo e($staff->name); ?>" required>
            </div>
          </div>
          <div class="form-group row">
            ...
            <div class="col-sm-10">
              <select name="role" class="form-control" required>
                <option value="1" <?php echo e($staff->role == 'admin' ? 'selected' : ''); ?>>Admin</option>
                <option value="2" <?php echo e($staff->role == 'interviewer' ? 'selected' : ''); ?>>Interviewer</option>
              </select>
            </div>
          </div>
          <div class="form-group row">
            <div class="col-sm-12 text-right">
              ...
              <a href="<?php echo e(route('staff.assign')); ?>" class="btn btn-secondary">Cancel</a>
            </div>
          </div>
        </form>
      </div>
...
</html><?php /**PATH C:\xampp\htdocs\rtas_system\resources\views/admin/editStaff.blade.php ENDPATH**/ ?>