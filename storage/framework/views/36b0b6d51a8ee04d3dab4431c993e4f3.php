        ...
        <div class="form-container">
            ...
            <div class="form-group row">
              ...
              <div class="col-sm-4">
                <select class="form-control" id="major" name="major">
                  ...
                  <option value="tulen" <?php echo e(old('major', $academic->major ?? '') == 'tulen' ? 'selected' : ''); ?>>Sains Tulen</option>
                  <option value="agama" <?php echo e(old('major', $academic->major ?? '') == 'agama' ? 'selected' : ''); ?>>Sains Agama</option>
                </select>
              </div>
          ...
          <div class="table-responsive">
            ...
            <table class="table table-striped">
              ...
              <tbody>
                <?php
                  $subjects = ['Bahasa Melayu', 'Sejarah', 'English', 'Mathematic', 'Physic', 'Chemistry', 'Biology', 'Additional Mathematics'];
...
</html><?php /**PATH C:\xampp\htdocs\rtas_system\resources\views/applicant/academicForm.blade.php ENDPATH**/ ?>