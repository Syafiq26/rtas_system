      ...
      <div class="main-content">
        ...
        <form method="post" action="<?php echo e(route('staff.store')); ?>" class="form-container">
          ...
          <div class="d-flex justify-content-end">
            ...
            <a href="<?php echo e(route('staff.assign')); ?>" class="btn btn-danger">Back</a>
          </div>
        </form>
      </div>
    </main>
...
</html><?php /**PATH C:\xampp\htdocs\rtas_system\resources\views/admin/addStaff.blade.php ENDPATH**/ ?>