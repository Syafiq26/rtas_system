        ...
        <div class="form-container">
          ...
          <div class="table-responsive mt-4">
            <?php $__currentLoopData = $questionsByInterviewer; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $interviewer_id => $questions): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
              <h5>Interviewer Name: <?php echo e($questions->first()->interviewer_name); ?></h5><!-- Add interviewer name as a header -->
            ...
            <div class="table-success mt-4">
                <h4><strong>Final Average Score: <?php echo e($totalScore); ?>/30</strong></h4>
            </div>
        </div>
...
</html><?php /**PATH C:\laragon\www\rtas_system\resources\views/admin/viewIVMark.blade.php ENDPATH**/ ?>