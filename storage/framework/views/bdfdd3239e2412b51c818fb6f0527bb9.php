            ...
            <div class="sidebar-sticky">
                <ul class="nav flex-column">
                    ...
                    <li class="nav-item nav-item-asset pb-4">
                        ...
                        <ul class="nav flex-column sub-menu">
                            <li class="nav-item pb-2">
                                <a class="nav-link" href="<?php echo e(route('recommend.index')); ?>">
                                    <span class="nav-link-text">Recommended</span>
                                </a>
                            </li>
                            <li class="nav-item pb-2">
                                <a class="nav-link" href="<?php echo e(route('kiv.index')); ?>">
                                    <span class="nav-link-text">KIV</span>
                                </a>
                            </li>
                            <li class="nav-item pb-2">
                                <a class="nav-link" href="<?php echo e(route('admin.interviewerMark')); ?>">
                                    <span class="nav-link-text">Interview Marks</span>
                                </a>
                            </li>
                        </ul>
                    </li>
                    ...
                    <li class="nav-item pb-4">
                        <a class="nav-link" href="<?php echo e(route('staff.assign')); ?>">
                            <i class="lni lni-user"></i>
                            <span class="nav-link-text">Assign Staff</span>
                        </a>
                    </li>
...
</html><?php /**PATH C:\xampp\htdocs\rtas_system\resources\views/admin/sidebar.blade.php ENDPATH**/ ?>