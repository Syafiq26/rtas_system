            ...
            <div class="sidebar-sticky">
                <ul class="nav flex-column">
                    ...
                    <li class="nav-item py-4">
                        <a class="nav-link" href="<?php echo e(route('applicant.home')); ?>">
                    ...
                    <li class="nav-item nav-item-asset pb-4">
                        ...
                        <ul class="nav flex-column sub-menu">
                            <li class="nav-item pb-2">
                                <a class="nav-link" href="<?php echo e(route('personal.form')); ?>">
                                    <span class="nav-link-text">Personal Details</span>
                                </a>
                            </li>
                            <li class="nav-item pb-2">
                                <a class="nav-link" href="<?php echo e(route('academic.form')); ?>">
                                    <span class="nav-link-text">Academic Details</span>
                                </a>
                            </li>
                            <li class="nav-item pb-2">
                                <a class="nav-link" href="<?php echo e(route('cocuriculum.form')); ?>">
                                    <span class="nav-link-text">Extra- Curricular Activities</span>
                                </a>
                            </li>
                            <li class="nav-item pb-2">
                              <a class="nav-link" href="<?php echo e(route('parent.form')); ?>">
                                  <span class="nav-link-text">Details of Parents/Guardian</span>
                              </a>
                          </li>
                          <li class="nav-item pb-2">
                            <a class="nav-link" href="<?php echo e(route('siblings.form')); ?>">
                    ...
                    <li class="nav-item pb-4">
                        <a class="nav-link" href="<?php echo e(route('applicant.declaration')); ?>">
...
<?php /**PATH C:\xampp\htdocs\rtas_system\resources\views/applicant/sidebar.blade.php ENDPATH**/ ?>