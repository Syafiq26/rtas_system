            ...
            <div class="sidebar-sticky">
                <ul class="nav flex-column">
                    ...
                    <li class="nav-item nav-item-asset pb-4">
                        ...
                        <ul class="nav flex-column sub-menu">
                            <li class="nav-item pb-2">
                                <a class="nav-link" href="{{ route('recommend.index') }}">
                                    <span class="nav-link-text">Recommended</span>
                                </a>
                            </li>
                            <li class="nav-item pb-2">
                                <a class="nav-link" href="{{ route('kiv.index') }}">
                                    <span class="nav-link-text">KIV</span>
                                </a>
                            </li>
                            <li class="nav-item pb-2">
                                <a class="nav-link" href="{{ route('admin.interviewerMark') }}">
                    ...
                    <li class="nav-item pb-4">
                        <a class="nav-link" href="{{ route('staff.assign') }}">
