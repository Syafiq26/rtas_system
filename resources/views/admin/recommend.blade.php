          ...
          <table class="table table-striped">
            ...
            <tbody>
              ...
              <tr>
                ...
                <td>
                    <input type="text" class="form-control" value="{{ $applicant->applicant_id }}" readonly>
                </td>
                <td>
                    <input type="text" class="form-control" value="{{ $applicant->name }}" readonly>
                </td>
                <td>
                    <input type="text" class="form-control"value="{{ $applicant->score }}" readonly>
                </td>
                <td>
                    <a href="{{ route('recommend.viewCandidate', $applicant->id) }}" class="btn btn-secondary btn-sm">View</a>
                </td>
              </tr>
              @endforeach
            </tbody>
